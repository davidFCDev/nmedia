...
const clients = [
    {
        ...
        tag: '@neronestudio',
        quote: '"NNMedia provided me with content of my products unlike anyone before - eye-catching and cinematic while keeping it clean"',
        href: '#',
        imageSrc:
    ...
    },
    {
        ...
        tag: '@after.the.store',
        quote: '"Simply a pleasure to work with, incredibly professionally done photos and videos for our socials"',
        href: '#',
        imageSrc:
            'https://tailwindui.com/img/ecommerce-images/product-page-03-related-product-01.jpg',
        imageAlt:
        ...
        >
            <div className="mx-auto max-w-7xl text-center ">
                ...
                <p className="mt-4 text-lg tracking-tight text-gray-100">
                    Join the growing list of satisfied N&N Media clients who are
            ...
            <div className=" py-24">
                <div className="mx-auto max-w-7xl px-6 lg:px-8">
                    <div className="mx-auto max-w-2xl lg:mx-0 lg:max-w-none">
                        ...
                        <h1 className="mt-2 text-center text-3xl font-bold tracking-tight text-[#2BB849] underline underline-offset-4 sm:text-4xl">
                            Trusted by businesses all around the globe!
                        </h1>
                        <div className="mx-auto mt-10 grid max-w-xl grid-cols-1 items-center gap-8 text-center text-base leading-7 text-gray-100 lg:max-w-none lg:grid-cols-2">
                            <div className="text-base lg:text-xl">
                                <p>
                                    Act fast – we&apos;re only accepting 5
                                    clients per week!
                                </p>
                            </div>
                            <div>
                                <p>
                                    At NN Media, we believe in putting our money
                                    where our mouth is.
                                </p>
                                <p className="mt-8">
                                    That&apos;s why we proudly offer a 100%
                                    satisfaction guarantee, which means if
                                    you&apos;re not completely happy with the
                                    content we provide, we&apos;ll make
                                    unlimited revisions free of charge until it
                                    meets your expectations.
                                </p>

                                <p className="mt-8">
                                    Your happiness and success are our main
                                    focus!
                                </p>
                            </div>
                        </div>
