            ...
            <div className="px-6 py-16 sm:px-6 lg:px-8">
                <div className="mx-auto max-w-2xl text-center">
                    <h2 className="text-3xl font-bold tracking-tight text-gray-50 sm:text-4xl">
                        Get ready to stand out in the digital crowd and make
                        your social media soar to new heights.
                    </h2>
                    <p className="mx-auto mt-6 max-w-xl text-lg leading-8 text-gray-300">
                        We specialize in creating captivating and professional
                        content that sparks engagement, propels your brand, and
                        leaves your audience craving more. <br />
                    </p>
                ...
                <div className="mx-auto max-w-7xl px-6 lg:px-8">
                    <div className="mx-auto max-w-2xl lg:text-center">
                        <p className="mt-2 text-3xl font-bold tracking-tight text-gray-50 sm:text-4xl">
                            The Eye-Opening Statistics About Instagram You Need
                            to See !
                        </p>
                    </div>
